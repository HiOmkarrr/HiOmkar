    ...
    <section id="projects" className="pt-28 pb-12 sm:pt-24 sm:pb-16 lg:py-20">
      ...
      <div className="flex justify-center mt-12 sm:mt-16 px-4 sm:px-0">
        ...
        >
          ...
          />
          {/* link to add: https://ds-sem-7.streamlit.app/ */}
          <Project
            title="DS SEM 7"
            description="A Streamlit-based data science project showcasing semester 7 work with interactive analysis and visual outputs."
