...
const SKILL_CATEGORIES = [
  ...
  },
  {
    id: "aiml",
    name: "AI / ML & GenAI",
    shortName: "AI/ML & GenAI",
    icon: BrainCircuit,
    description: "Machine learning algorithms, RAG architectures, neural embeddings & retrieval pipelines",
    skills: [
      { name: "RAG", iconName: "rag", level: 88, levelLabel: "Advanced", color: "#00f5ff" },
      { name: "CRAG", iconName: "crag", level: 82, levelLabel: "Advanced", color: "#8a2be2" },
      { name: "MMR", iconName: "mmr", level: 80, levelLabel: "Advanced", color: "#ff1493" },
      { name: "Hybrid Embeddings", iconName: "hybrid embeddings", level: 85, levelLabel: "Advanced", color: "#3ecf8e" },
      { name: "HyDE", iconName: "hyde", level: 80, levelLabel: "Advanced", color: "#f89820" },
